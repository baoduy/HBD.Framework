...
namespace HBD.Framework.Configuration
{
    ...
    public static class ConfigurationManager
    {
        ...
        /// <summary>
        ///     Consolidate connection will replace the dash '\' with '\\' to ensure the string can assigned to
        ///     DbConnectionStringuilder.
        /// </summary>
        /// <param name="connectionString"></param>
        /// <returns></returns>
        //public static string ConsolidateConnectionString(string connectionString)
        //{
        //    if(connectionString.IsNullOrEmpty())return connectionString;
        //    return connectionString.Count('\\')>1 ? connectionString : connectionString.Replace(@"\", @"\\");
        //}
    }
}