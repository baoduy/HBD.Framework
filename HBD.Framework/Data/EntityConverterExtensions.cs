...
namespace HBD.Framework
{
    public static class EntityConverterExtensions
    {
        ...
        /// <summary>
        /// Mapping a DataReader to entity. If entity property name is difference with Database Field using ColumnAttribute to custonmize it.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="this"></param>
        /// <param name="ignoreEmptyRows"></param>
        /// <returns></returns>
        public static IEnumerable<T> MappingTo<T>(this IDataReader @this, bool ignoreEmptyRows = true) where T : class, new()
        {
        ...
        public static Task<IEnumerable<T>> MappingToAsync<T>(this IDataReader @this, bool ignoreEmptyRows = true) where T : class, new()
        {
        ...
        public static IEnumerable<T> MappingTo<T>(this DataTable @this, bool ignoreEmptyRows = true) where T : class, new()
        {
        ...
        public static Task<IEnumerable<T>> MappingToAsync<T>(this DataTable @this, bool ignoreEmptyRows = true) where T : class, new()
        {
            var task = new TaskCompletionSource<IEnumerable<T>>();
            task.SetResult(@this.MappingTo<T>(ignoreEmptyRows));
            return task.Task;
