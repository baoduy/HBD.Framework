...
namespace HBD.Framework
{
    ...
    {
        public static IEnumerable<PropertyInfo> GetProperties<T>(this T @this, params string[] propertyNames) where T : class
        {
        ...
        public static PropertyInfo GetProperty<T>(this T @this, string propertyName) where T : class
        {
            ...
            return @this.GetType().GetProperty(propertyName, BindingFlags.IgnoreCase | BindingFlags.Public | BindingFlags.Instance);
        }
