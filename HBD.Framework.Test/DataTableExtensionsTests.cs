...
using HBD.Framework.Data.DataReplacements;
...
namespace HBD.Framework.Tests
{
    ...
    public class DataTableExtensionsTests
    {
        ...
        {
            IO.DirectoryEx.DeleteFiles("TestData\\", "Test*.csv");
        }
        ...
        {
            var tb = new DataTable();
            tb.LoadFromCsv("TestData\\Employees_PileDilimiters.csv", op => op.Dilimiters = new string[] { "|" });
        ...
        {
            var tb = ((DataTable)null).LoadFromCsv("TestData\\Employees.csv", op => op.Dilimiters = new string[] { "|" });
            Assert.IsNull(tb);
        }
        ...
        {
            var tb = new DataTable().LoadFromCsv("TestData\\AAA.csv", op => op.Dilimiters = new string[] { "|" });
