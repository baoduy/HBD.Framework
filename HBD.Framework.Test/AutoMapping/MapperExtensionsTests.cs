...
namespace HBD.Framework.AutoMapping.Tests
{
    ...
    public class MapperExtensionsTests
    {
        ...
        public void CreateData()
        {
            ...
            data.Rows.Add(new object[] { "Hoang", 1, "Enum2", null, "AA" });
            data.Rows.Add(new object[] { "Duy", 2, TestEnum.Enum2, 123, "BB" });
            data.Rows.Add();
        }
        ...
        private void AssertResults(bool ignoreEmptyRows = true)
        {
            ...
            Assert.IsTrue(results.Any(e => e.Name == "Hoang" && e.Id == 1 && e.Type == TestEnum.Enum2 && e.Summary == "AA"));
