...
{
    internal sealed class AzApplicationScopeWrapper
    {
        private readonly IAzApplication _application;
        private readonly IAzScope _scope;

        public bool IsApplication => this._application != null && this._scope == null;
        public bool IsScope => this._scope != null && this._application == null;
        ...
        public IAzApplication Application => this._application;
        public IAzScope Scope => this._scope;
        public IAzOperations Operations
        {
            get
            {
                if (_application != null) return _application.Operations;
                throw new NotSupportedException($"{MethodBase.GetCurrentMethod().Name}_{Name}_{Type.Name}");
            }
        }
        ...
        public void DeleteOperation(string name)
        {
            ...
            else throw new NotSupportedException($"{MethodBase.GetCurrentMethod().Name}_{Name}_{Type.Name}");
        }
